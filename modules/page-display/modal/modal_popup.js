...
//初始化
const PopupInit = ({title, content, btns}) => {
    const css = theme.get();
...
const alert = (content = '', params = {title: undefined, btnText: undefined}) => {
    ...
    return new Promise((resolve => {
        ...
        const popup = PopupInit({title, content: contentData, btns});
...
const confirm = (content = '', params = {title: undefined, btns: [{}, {}]}) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        const popup = PopupInit({title, content: contentData, btns: params.btns});
        show(style.popup, popup);
    });
};
